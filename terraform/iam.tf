#
# GreenCity AWS Infrastructure - IAM Roles and Policies
# Creates IAM roles for EKS cluster, node group, and ALB controller
#
...
resource "aws_iam_role_policy" "eks_nodes_secrets" {
  name = "${var.project_name}-eks-nodes-secrets"
